...
fn test_info_shows_platform_information() -> Result<(), Box<dyn std::error::Error>> {
    ...
    assert!(stdout.contains("Platform Information:"), "Should show platform information section");
...
fn test_info_shows_environment_information() -> Result<(), Box<dyn std::error::Error>> {
    ...
    assert!(stdout.contains("Environment:"), "Should show environment section");
...
fn test_info_shows_directory_information() -> Result<(), Box<dyn std::error::Error>> {
    ...
    assert!(stdout.contains("Directories:"), "Should show directories section");
